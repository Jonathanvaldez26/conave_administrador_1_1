...
<script>
    ...
    $(document).ready(function() {
        ...
        let codigo = '';
        var link_a = $(location).attr('href');
        var clave_a = link_a.substr(link_a.indexOf('Gastro/')+11,link_a.length);
        ...
        $("#codigo_registro").on('change',function(){
            ...
            $.ajax({
                url: "/RegistroLinea/registroAsistenciaGastro/"+codigo+'/'+clave_a,
                type: "POST",
                // data: formData,
                dataType: 'json',
                beforeSend: function() {
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta.status == 'success') {
                        ...
                        Swal.fire({
                            title: '¡Lo sentimos, esta persona no pertenece a la Línea Gastro!',
                            // html: 'I will close in <b></b> milliseconds.',
                            icon: 'warning',
                            timer: 1000,
                            // timerProgressBar: true,
