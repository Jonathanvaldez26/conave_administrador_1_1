...
<script>
    ...
    $(document).ready(function() {
        ...
        let codigo = '';
        var link_a = $(location).attr('href');
        var clave_a = link_a.substr(link_a.indexOf('MedicinaGeneral/')+11,link_a.length);
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta.status == 'success') {
                        ...
                        Swal.fire({
                            title: '¡Lo sentimos, esta persona no pertenece a la Línea Medicina General!',
                            // html: 'I will close in <b></b> milliseconds.',
                            icon: 'warning',
                            timer: 1000,
                            // timerProgressBar: true,
